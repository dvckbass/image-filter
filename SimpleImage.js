    ...
    var funMap = [
        ...
        function (source) {
            if (source instanceof HTMLImageElement) {
                ...
                return __SimpleImageUtilities.makeHTMLImageFromURL(
                    source,
                    this
                );
            } else if (
        ...
        function (width, height) {
            if (width > 0 && height > 0) {
                return __SimpleImageUtilities.makeHTMLImageFromSize(
                    width,
                    height
                );
            } else {
...
SimpleImage.prototype = {
    ...
    __init: function (img) {
        try {
            ...
            console.log(err);
            __SimpleImageUtilities.throwError(
                "The name you used to create a SimpleImage was not correct: " +
                    img.id
            );
        }
    },
